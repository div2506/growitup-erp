    ...
    <Dialog open onOpenChange={(o) => { if (!o) onClose(); }}>
      <DialogContent className="bg-[#2F2F2F] border border-white/10 text-white sm:max-w-lg w-[calc(100%-2rem)] rounded-xl max-h-[90dvh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          {/* Shift Info */}
          {shiftLoading && (
            <div className="bg-[#191919] rounded-lg border border-white/10 px-4 py-3 animate-pulse">
              <div className="h-2.5 bg-white/10 rounded w-1/4 mb-2" />
      ...
      <div className="bg-[#2F2F2F] rounded-xl border border-white/10">
        ...
        {loading ? (
          <div className="space-y-3 animate-pulse">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-[#2F2F2F] rounded-xl border border-white/10 p-4">
